...
it('lists multiple third-party services and their validation state', async () => {
  ...
  vi.stubGlobal('fetch', vi.fn().mockImplementation(async (input: RequestInfo | URL) => {
    ...
    if (url.endsWith('/api/system/info')) return { ok: true, status: 200, json: async () => ({ application: 'shiyao-review', version: '0.2.2-beta', packaged: false, setup_complete: true, data_directory: 'data', log_directory: 'logs' }) }
